...
class OrderServiceImplTest {
    ...
    // unhappy: update order status with invalid status
    @Test
    ...
    // unhappy: update order with unused ID
    @Test
    ...
    // unhappy: find order with unused ID
    @Test
    ...
    // happy: find order with valid author name
    @Test
    ...
    // unhappy: find order with an all-lowercase author name
    @Test
